import { fetchEmailDraftById, type EmailDraftRow } from '@/lib/data/email-drafts-actions'
    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="outline" size="sm" asChild>
          <Link href="/dashboard/client-updates">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Client Updates
          </Link>
        </Button>
      </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="text-sm">
                {sentTo.length === 0 ? (
                  ...
                  <div>
                    <div className="mb-1">{sentTo.length} recipients:</div>
